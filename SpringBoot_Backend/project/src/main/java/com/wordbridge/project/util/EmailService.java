...
public class EmailService {
    ...
    public void sendVerificationEmail(String to, String name, String token) throws MessagingException {
        ...
        String link = frontUrl + "/verify-email?token=" + token;
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <p style="color:#dbeafe; margin-top:10px;">
                                                Fast & Reliable Job Portal And Freelancing Connection Service
                                            </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="padding:40px; color:#334155;">
                                            ...
                                            <p style="font-size:16px; line-height:1.7;">
                                                Thank you for registering with WorkBridge.
        ...
        sendSimpleMail(to, "Verify your WorkBridge account", body);
    }
    ...
    public void sendPasswordResetEmail(String to, String name, String token) throws MessagingException {
        ...
        sendSimpleMail(to, "Reset your WorkBridge password", body);
    }
