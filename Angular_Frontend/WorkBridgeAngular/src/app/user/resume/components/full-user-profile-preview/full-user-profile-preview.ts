...
@Component({
  selector: 'app-full-user-profile-preview',
  imports: [CommonModule],
  templateUrl: './full-user-profile-preview.html',
  styleUrl: './full-user-profile-preview.css',
})
export class FullUserProfilePreview implements OnInit {
