...
@Component({
  ...
  templateUrl: './admin-company-management.html',
  styleUrl: './admin-company-management.css',
})
export class AdminCompanyManagement implements OnInit {
  ...
  delete(company: CompanyProfileResponseModel): void {
