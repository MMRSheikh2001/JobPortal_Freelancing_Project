...
class ResumeImportPreviewDTO {
  ...
  /// Factory constructor to create [ResumeImportPreviewDTO] from a JSON map.
  factory ResumeImportPreviewDTO.fromJson(Map<String, dynamic> json) {
  ...
  /// Converts this [ResumeImportPreviewDTO] instance into a JSON-compatible map.
  ...
  ResumeImportPreviewDTO copyWith({
